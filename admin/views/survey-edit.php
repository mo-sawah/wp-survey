...
<div class="wrap">
    ...
    <div class="wp-survey-admin-container">
        <div class="wp-survey-admin-main">
                    ...
                    <table class="form-table">
                            ...
                            <td>
                                <select id="survey_type" name="survey_type" class="regular-text">
                                    ...
                                    <option value="multi-question" <?php echo ($survey && $survey->survey_type === 'multi-question') ? 'selected' : ''; ?>>
                                        <?php _e('Multi-Question Survey', 'wp-survey'); ?>
                                    </option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description"><?php _e('Users will be asked to follow your page before submitting.', 'wp-survey'); ?></p>
                            </td>
                        </tr>
                        <tr>
            ...
            <?php if ($survey && $survey->survey_type === 'simple'): ?>
            <!-- SIMPLE SURVEY: Choices -->
            <div class="wp-survey-card">
        ...
        <div class="wp-survey-admin-sidebar">
            ...
            <div class="wp-survey-card">
                ...
                <ol style="padding-left: 20px; line-height: 1.8;">
                    <li><?php _e('Choose survey type', 'wp-survey'); ?></li>
