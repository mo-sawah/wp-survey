...
<div class="wp-survey-multi-container" data-survey-id="<?php echo $survey->id; ?>" data-mode="all-questions">
    ...
    <div class="wp-survey-all-questions-screen <?php echo !$survey->intro_enabled ? 'active' : ''; ?>">
        <div class="wp-survey-card">
            
            <!-- Progress Bar -->
            <div class="wp-survey-progress-wrapper">
                <div class="wp-survey-progress-text">
                    <span class="wp-survey-answered-count">0</span> <?php _e('of', 'wp-survey'); ?> <?php echo count($questions_data); ?> <?php _e('answered', 'wp-survey'); ?>
                </div>
            ...
            <div class="wp-survey-content">
                ...
                <div class="wp-survey-buttons">
                    <button type="submit" class="wp-survey-button wp-survey-button-primary wp-survey-submit-all-btn" disabled>
